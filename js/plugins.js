// Generated by RPG Maker MV Editor
var $plugins = [
  {
  ...
  },
  {
    "name": "SkyBox",
    "status": true,
    "description": "Three.js SkySphere - 3D 모드에서 파노라마 하늘 배경 표시",
    "parameters": {
      "Skybox Folder": "skybox",
      "Panorama File": "sky_panorama.png"
    }
  },
  {
    "name": "TitleCredit",
    "status": true,
    "description": "타이틀 화면에 Credit 버튼 추가",
    "parameters": {}
  },
  {
    "name": "WASD_Movement",
    "status": true,
    "description": "WASD 키로 이동, Q/E 키로 PageUp/PageDown 매핑",
    "parameters": {}
  },
  {
    "name": "TouchDestAnimation",
    "status": true,
